...
class ScriptManager
{
	...
	{		
        ...
        $cs->registerScriptFile($baseUrl."/assets/js/jquery-1.11.2.min.js" 	,CClientScript::POS_END);         
		...
		$cs->registerScriptFile($baseUrl."/assets/js/modernizr.js"
		,CClientScript::POS_END); 
				
		$cs->registerScriptFile($baseUrl."/assets/js/common_scripts_min.js"
		,CClientScript::POS_END); 		
	
		
		$cs->registerScriptFile($baseUrl."/assets/js/validate.js"
		,CClientScript::POS_END); 
		
		$cs->registerScriptFile($baseUrl."/assets/js/video_header.js"
		,CClientScript::POS_END); 
		
		$cs->registerScriptFile($baseUrl."/assets/js/wow.min.js"
		,CClientScript::POS_END); 
		
		$cs->registerScriptFile($baseUrl."/assets/js/wow.js"
		,CClientScript::POS_END); 		
		
		$cs->registerScriptFile($baseUrl."/assets/js/functions.js"
		,CClientScript::POS_END);
		
		$cs->registerScriptFile($baseUrl."/assets/js/ion.rangeSlider.js"
		,CClientScript::POS_END);
		...
		$cs->registerScriptFile($baseUrl."/assets/js/slider.js"
		,CClientScript::POS_END); 
	}
	...
	public static function registerAllCSSFiles()
	{
		$baseUrl = Yii::app()->baseUrl; 
		$cs = Yii::app()->getClientScript();
		$cs->registerCssFile($baseUrl.'/assets/css/external.css?ver=1.0');		
		...
		$cs->registerCssFile($baseUrl.'/assets/css/base.css?ver=1.0');
		$cs->registerCssFile($baseUrl.'/assets/css/skins/square/grey.css');
		$cs->registerCssFile($baseUrl.'/assets/css/ion.rangeSlider.css');
		$cs->registerCssFile($baseUrl.'/assets/css/ion.rangeSlider.skinFlat.css');
