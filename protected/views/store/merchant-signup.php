...
<div class="sections section-grey">
  ...
  <div class="container">
    ...
    <div class="top25">
      ...
      <form onsubmit="return false;" method="POST" class="frm-resume-signup bottom10 uk-form has-validation-callback" id="frm-resume-signup">
      ...
      <?php echo CHtml::hiddenField('currentController','store')?>      
	   ...
	   <div class="row top10">		  
		...
		<div class="row top10">	
		<div class="col-md-4">
		  <input type="submit" class="orange-button medium btn_1" value="<?php echo Yii::t("default","Submit")?>">
		</div>
		</div>
